...
presented at the top of the dashboard with tooltip at each continents to
show life expectancy data related to the selected continent. Under the
world map section, there is a scatter-plot for each countries with Life
expectancy as fixed y-axis and the users will be able to change the
dimension in x-axis, color and size. This is required to perform
